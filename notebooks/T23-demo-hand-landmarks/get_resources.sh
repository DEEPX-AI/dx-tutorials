...
DOWNLOAD_URL="https://cs.deepx.ai/_deepx_fae_archive/dx-tutorials/hand-landmarks.tar.gz"
REQUIRED_FILES=(
    "${RESOURCE_DIR}/models/hand-detector_192x192.dxnn"
    "${RESOURCE_DIR}/models/HandLandmarkLite.dxnn"
    "${RESOURCE_DIR}/videos/hands.mp4"
)
