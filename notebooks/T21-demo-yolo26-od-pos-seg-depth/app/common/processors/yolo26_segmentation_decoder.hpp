/**
 * @file yolo26_segmentation_decoder.hpp
 * @brief Instance segmentation decoder used by the YOLO26 tutorial model.
 */
#ifndef YOLO26_SEGMENTATION_DECODER_HPP
#define YOLO26_SEGMENTATION_DECODER_HPP
...
#endif  // YOLO26_SEGMENTATION_DECODER_HPP
